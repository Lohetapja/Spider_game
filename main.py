...
ball_obj = pygame.draw.circle(
    surface=screen, color=black, center=[100, 100], radius=40)
...
# enemy_surface = pygame.image.load("graphics/enemy.png")
...
while running:
    ...
    # screen.fill("grey") # fill the screen with a grey color
